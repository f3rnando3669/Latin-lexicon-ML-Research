...
class PromptList:
    ...
    def add_symbol_prompt_multi_shot(self, ref_var, model1_txt, model1_response, model2_txt, model2_response, model3_txt, model3_response, model4_txt) -> None:
        self.add_prompt(
            [f"Using {ref_var} and explain each setence step by step.\nText:\n{model1_txt}\nComprehensive Symbols:\n{model1_response}\nText:{model2_txt}\nComprehensive Symbols:\n{model2_response}\nText:\n{model3_txt}\nComprehensive Symbols:\n{model3_response}\nText:\n{model4_txt}",0])
