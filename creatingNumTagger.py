...
def is_numerical(x): #this is a ridiculous function
	...
	if '1' in x or '2' in x or '3' in x or '4' in x or '5' in x or '6' in x or '7' in x or '8' in x or '9' in x:
		return True 
	elif 'one' in x or 'two' in x or 'three' in x or 'four' in x or 'five' in x or 'six' in x or 'seven' in x or 'eight' in x or 'nine' in x:
		return True
	elif 'ten' in x or 'eleven' in x or 'thirty' in x or 'twelve' in x or 'thirteen' in x or 'fifteen' in x or 'twenty' in x or 'forty' in x or 'fifty' in x:
		return True
